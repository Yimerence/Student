<template>
  <div>
    <div class="card" style="margin-bottom: 10px">
      <el-input style="width: 260px; margin-right:10px" v-model="data.courseName" class="w-50 m-2" placeholder="请输入课程名称查询" :prefix-icon="Search"/>
      <el-input style="width: 260px; margin-right:10px" v-model="data.studentName" class="w-50 m-2" placeholder="请输入学生名称查询" :prefix-icon="Search"/>

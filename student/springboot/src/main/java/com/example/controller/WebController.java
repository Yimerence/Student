...
//    private Result success(Admin dbAdmin) {
//        return null;
//    }

    //登录接口
    @PostMapping("/login")
    public Result login(@RequestBody Account account) throws CustomException {
        Account dbAccount;
    ...
    public Result register(@RequestBody Account account) throws CustomException {
